...
def get_generated_gamedata_dataset(n: int | None = None, simulated: bool = False, sim_value_acc: float = 0.5, sim_policy_acc: float = 0.5) -> tuple[Dataset, set[Board], set[Board]]:
    '''
