...
def gamedata_to_experiencedata(gamedata: GameData[T_state, T_action], model: FullModelOnRaw[Any, T_state, T_action]) -> list[ExperienceData]:
    '''
...
def _play_process(
        ...
        player: FullModelPlayer[RecursiveFullOnRawModel[Any], T_state, T_action],
